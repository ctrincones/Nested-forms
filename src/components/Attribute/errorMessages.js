...
export const nameValidationError =
  <i>Required field, attributes names must be unique</i>;

export const precisionError = <i>Invalid precision value</i>;

export const accuracyError = <i>Invalid accuracy value</i>;
